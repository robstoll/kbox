 ...
 */
@Deprecated(
    "switch to isNotNullNorEmpty, will be removed with 4.0.0",
    ReplaceWith("this.isNotNullNorEmpty()", "ch.tutteli.kbox.isNotNullNorEmpty")
)
 ...
 */
@Deprecated(
    "switch to isNotNullNorBlank, will be removed with 4.0.0",
    ReplaceWith("this.isNotNullNorBlank()", "ch.tutteli.kbox.isNotNullNorBlank")
)
@OptIn(ExperimentalContracts::class)
