...
class Tuple7PrependTest {

    @Test
    fun prepend_1_values__results_in_a_Tuple8() {
        ...
        expect(
            Tuple7(a1, a2, a3, a4, a5, a6, a7)
                .prepend(a8)
        ).toBeAnInstanceOf<Tuple8<List<Byte>, List<String>, List<Int>, List<Long>, List<Float>, List<Double>, List<Char>, List<Short>>> {
            feature { f(it::a1) }.toBeTheInstance(a8)
            ...
            feature { f(it::a8) }.toBeTheInstance(a7)
        }
    }

    @Test
    fun prepend_2_values__results_in_a_Tuple9() {
        val a1 = listOf("string")
        val a2 = listOf(1)
        val a3 = listOf(2L)
        val a4 = listOf(3F)
        ...
        expect(
            Tuple7(a1, a2, a3, a4, a5, a6, a7)
                .prepend(a8, a9)
        ).toBeAnInstanceOf<Tuple9<List<Byte>, List<List<Int>>, List<String>, List<Int>, List<Long>, List<Float>, List<Double>, List<Char>, List<Short>>> {
            feature { f(it::a1) }.toBeTheInstance(a8)
            feature { f(it::a2) }.toBeTheInstance(a9)
            ...
            feature { f(it::a9) }.toBeTheInstance(a7)
        }
    }
