...
class Tuple8PrependTest {

    @Test
    fun prepend_1_values__results_in_a_Tuple9() {
        ...
        expect(
            Tuple8(a1, a2, a3, a4, a5, a6, a7, a8)
                .prepend(a9)
        ).toBeAnInstanceOf<Tuple9<List<List<Int>>, List<String>, List<Int>, List<Long>, List<Float>, List<Double>, List<Char>, List<Short>, List<Byte>>> {
            feature { f(it::a1) }.toBeTheInstance(a9)
            ...
            feature { f(it::a9) }.toBeTheInstance(a8)
        }
    }
