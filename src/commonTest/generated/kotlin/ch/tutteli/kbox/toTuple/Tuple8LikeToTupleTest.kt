...
class Tuple8LikeToTupleTest {
    ...
    fun toTuple__returns_Tuple8_in_correct_order() {
        ...
        val dataClass = Dummy8(a1, a2, a3, a4, a5, a6, a7, a8)

        expect(dataClass.toTuple()).toBeAnInstanceOf<Tuple8<List<String>, List<Int>, List<Long>, List<Float>, List<Double>, List<Char>, List<Short>, List<Byte>>> {
    ...
    data class Dummy8(
        ...
        val a7: List<Short>,
        val a8: List<Byte>
    ): Tuple8Like<List<String>, List<Int>, List<Long>, List<Float>, List<Double>, List<Char>, List<Short>, List<Byte>>
}